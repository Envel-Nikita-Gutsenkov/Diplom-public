# Энциклопедия Базы Данных (DiplomSoft2)
...
Даже при удалении контейнера БД, ваши данные останутся на диске сервера в `/var/lib/docker/volumes/diplomsoft2_db_data`.
