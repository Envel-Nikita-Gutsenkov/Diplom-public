...
В проекте Diplom-public вместо традиционного REST API для взаимодействия с данными преимущественно используются **Server Actions**. Это обеспечивает полную типобезопасность (TypeScript) и упрощает разработку.
